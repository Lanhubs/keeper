...
class MainHome extends GetView {
  ...
  final List<BottomNavigationBarItem> _bottomNavItems = [
    BottomNavigationBarItem(
      icon: Icon(HugeIcons.strokeRoundedHome04, size: 20),
      label: "Home",
    ),
    BottomNavigationBarItem(
      icon: Icon(HugeIcons.strokeRoundedInvoice02, size: 20),
      label: "Invoices",
    ),
    BottomNavigationBarItem(
      icon: Icon(HugeIcons.strokeRoundedPieChart02, size: 20),
      label: "Analytics",
    ),
    BottomNavigationBarItem(
      icon: Icon(Icons.person_4_outlined, size: 20),
      label: "Profile",
    ),
  ];
